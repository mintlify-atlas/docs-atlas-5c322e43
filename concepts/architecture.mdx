---
title: "MCP Architecture: Host, Client, and Server"
sidebarTitle: "Architecture"
description: "Learn about the three roles in an MCP deployment — host, client, and server — and how Kunna MCP Client maps to each."
---
