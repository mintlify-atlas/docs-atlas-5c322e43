---
title: "Connecting to an MCP Server with Kunna Inspector"
sidebarTitle: "Connecting"
description: "Configure transport, URL, and authentication to connect the Kunna inspector to any MCP server over Streamable HTTP or SSE."
---
