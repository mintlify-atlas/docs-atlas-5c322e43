---
title: "Kunna MCP Client Full Configuration Reference Guide"
sidebarTitle: "Configuration"
description: "All configurable aspects of Kunna MCP Client — Vite dev server, production build, Docker port mapping, and nginx SPA routing setup."
---
