...
description: "Kunna MCP Client is a React + Vite browser app that connects to any MCP server, auto-discovers its tools, prompts, and resources, then executes them."
---
