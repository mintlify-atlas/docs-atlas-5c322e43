---
title: "Deploy Kunna MCP Client with Docker"
sidebarTitle: "Deployment"
description: "Build a production Docker image of Kunna MCP Client using a multi-stage Vite + nginx build, then run the container on port 5173."
---
